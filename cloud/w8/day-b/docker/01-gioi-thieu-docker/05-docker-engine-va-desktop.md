# Docker Engine và Docker Desktop

Chapter: Giới thiệu Docker

## Mục tiêu

- Hiểu bản chất của `Docker Engine`, `Docker Desktop`, `Linux VM`, `contexts`.
...
Trong Docker, chủ đề **Docker Engine và Docker Desktop** cần được hiểu theo hướng thực chiến: không chỉ nhớ định nghĩa, mà phải biết đối tượng nào được tạo ra, dữ liệu nằm ở đâu, quyền hạn ra sao và khi lỗi thì kiểm tra từ lớp nào trước.
...
Engine --> Topic["Docker Engine và Docker Desktop"]
Topic --> Result["Ứng dụng chạy nhất quán"]
```

## Ví dụ

Tình huống: bạn cần kiểm chứng nhanh chủ đề **Docker Engine và Docker Desktop** trên máy local trước khi đưa vào pipeline hoặc server lab.
