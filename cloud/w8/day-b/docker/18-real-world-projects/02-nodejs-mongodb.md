# Project 2: NodeJS + MongoDB

Chapter: Real-world Projects

## Mục tiêu

- Hiểu bản chất của `nodejs`, `mongodb`, `volume`.
...
Trong Docker, chủ đề **Project 2: NodeJS + MongoDB** cần được hiểu theo hướng thực chiến: không chỉ nhớ định nghĩa, mà phải biết đối tượng nào được tạo ra, dữ liệu nằm ở đâu, quyền hạn ra sao và khi lỗi thì kiểm tra từ lớp nào trước.
...
Engine --> Topic["Project 2: NodeJS + MongoDB"]
Topic --> Result["Ứng dụng chạy nhất quán"]
```

## Ví dụ

Tình huống: bạn cần kiểm chứng nhanh chủ đề **Project 2: NodeJS + MongoDB** trên máy local trước khi đưa vào pipeline hoặc server lab.
...
Project có mã nguồn chạy được trong thư mục con `projects/02-nodejs-mongodb` của chapter này. Hãy vào đúng thư mục project trước khi chạy command.
