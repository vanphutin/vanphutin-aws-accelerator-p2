# Project 7: GitLab Self-hosted

Chapter: Real-world Projects

## Mục tiêu

- Hiểu bản chất của `gitlab`, `ssh`, `backup`.
...
Trong Docker, chủ đề **Project 7: GitLab Self-hosted** cần được hiểu theo hướng thực chiến: không chỉ nhớ định nghĩa, mà phải biết đối tượng nào được tạo ra, dữ liệu nằm ở đâu, quyền hạn ra sao và khi lỗi thì kiểm tra từ lớp nào trước.
...
Engine --> Topic["Project 7: GitLab Self-hosted"]
Topic --> Result["Ứng dụng chạy nhất quán"]
```

## Ví dụ

Tình huống: bạn cần kiểm chứng nhanh chủ đề **Project 7: GitLab Self-hosted** trên máy local trước khi đưa vào pipeline hoặc server lab.
...
Project có mã nguồn chạy được trong thư mục con `projects/07-gitlab-self-hosted` của chapter này. Hãy vào đúng thư mục project trước khi chạy command.
