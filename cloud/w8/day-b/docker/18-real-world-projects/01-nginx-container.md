# Project 1: Nginx Container

Chapter: Real-world Projects

## Mục tiêu

- Hiểu bản chất của `nginx`, `static site`, `port`.
...
Trong Docker, chủ đề **Project 1: Nginx Container** cần được hiểu theo hướng thực chiến: không chỉ nhớ định nghĩa, mà phải biết đối tượng nào được tạo ra, dữ liệu nằm ở đâu, quyền hạn ra sao và khi lỗi thì kiểm tra từ lớp nào trước.
...
Engine --> Topic["Project 1: Nginx Container"]
Topic --> Result["Ứng dụng chạy nhất quán"]
```

## Ví dụ

Tình huống: bạn cần kiểm chứng nhanh chủ đề **Project 1: Nginx Container** trên máy local trước khi đưa vào pipeline hoặc server lab.
...
Project có mã nguồn chạy được trong thư mục con `projects/01-nginx-container` của chapter này. Hãy vào đúng thư mục project trước khi chạy command.
